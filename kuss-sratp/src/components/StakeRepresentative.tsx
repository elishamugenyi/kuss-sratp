...
// Flexible item to accommodate backend variations
    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 border border-teal-200 shadow-teal-100">
          ...
          <p className="text-gray-600 text-lg">Monitor stake-wide group progress and reports</p>
        </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredReports.map((r, idx) => {
                      const wardName = (r.wardname || r.ward_name || r.ward || r.wardName || 'Ward');
                      const groupName = (r.groupname || r.group_name || r.group || r.groupName || 'Group');
                      const participants = Number(r.totalparticipants || r.participants || r.totalParticipants || 0) || 0;
                      const progress = Number(r.progress || r.averageprogress || r.averageProgress || r.completion || 0) || 0;
                      return (
                        <tr key={idx}>
